...
export function SEOHead({
  title = 'NBA Duo - Daily Basketball Grid Game',
  description = "NBA Duo is a fun, brain-teasing puzzle where you fill the grid by following logical rules. It's perfect for NBA fans who love a good challenge!",
  image = 'https://www.profootballnetwork.com/games/nba-duo/nba-duo-og-image.png',
  url = typeof window !== 'undefined' ? window.location.href : 'https://www.profootballnetwork.com/games/nba-duo/',
  type = 'website',
  siteName = 'Pro Football Network',
  twitterCard = 'summary_large_image',
  twitterSite = '@PFSN365',
  keywords = 'NBA game, NBA daily challenge, basketball puzzle, NBA grid game, daily NBA game',
  author = 'PFSN',
  canonical
}: SEOHeadProps) {
  useEffect(() => {
    ...
    updateMetaTag('og:image', image.startsWith('http') ? image : `https://www.profootballnetwork.com/games/nba-duo${image}`, true);
    ...
    updateMetaTag('twitter:image', image.startsWith('http') ? image : `https://www.profootballnetwork.com/games/nba-duo${image}`);
